...
class MagicMemoryEnergyCL( Component ):
      ...
      for i in range(s.nports):
        ...
        if s.req_qs[i].deq.rdy() and s.resp_qs[i].enq.rdy():
          ...
          if   req.type_ == MemMsgType.READ:
            # energy
            update_energy("read", len_, mem_byte_width=s.mem_byte_width)
          ...
          #
            ...
            # energy
            update_energy("write", len_, mem_byte_width=s.mem_byte_width)
